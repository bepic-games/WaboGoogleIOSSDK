...
#ifndef WABOGOOGLE_SWIFT_H
#define WABOGOOGLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaboGoogle",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10WaboGoogle10WaboGoogle")
@interface WaboGoogle : NSObject <WaboSDKLifecycleProtocol>
+ (WaboGoogle * _Nonnull)sharedInstance SWIFT_WARN_UNUSED_RESULT;
/// is init complete
///
/// returns:
/// is init complete
...
- (void)setWaboGoogleInitDelegate:(void (^ _Nonnull)(id _Nullable))delegate;
...
@interface WaboGoogle (SWIFT_EXTENSION(WaboGoogle))
...
- (void)chechLogin:(void (^ _Nonnull)(id _Nullable))block;
@end
